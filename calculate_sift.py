...
"""
Step3. Find corresponding centers of each image
...
def n_array(n):
    ...
    return L
"""
Draw bar graph of topic distribution
"""
...
"""
Put images into different filefolders
"""
...
if __name__ == "__main__":
    ...
    build_centers(img_path, K)
    # 2. calculate image features
    data_mat, label = cal_vec(img_path, K)
    """
    ### Generate SIFT word frequency ###
    """
    word_frequency = data_mat.astype(np.int)
    np.savetxt("lda_result/sift_word_frequency_file.txt", word_frequency,fmt='%d', delimiter=' ')

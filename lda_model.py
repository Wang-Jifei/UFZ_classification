...
if __name__ == "__main__":
    ...
    print(lda_topic)
    np.savetxt("lda_result/doc_topic_distribution.txt", lda_topic, fmt='%6f', delimiter=' ')
    # print topic-word distribution
    print(lda.components_)
    np.savetxt("lda_result/topic_word_distribution.txt", lda.components_, fmt='%6f', delimiter=' ')
